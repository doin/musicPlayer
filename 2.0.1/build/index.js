...
gallery/musicPlayer/2.0.1/player/audio
gallery/musicPlayer/2.0.1/player/flash
gallery/musicPlayer/2.0.1/index
 ...
 * @module musicPlayer
 **/
KISSY.add('gallery/musicPlayer/2.0.1/player/audio',function (S, Node) {
 ...
 * @module musicPlayer
 **/
KISSY.add('gallery/musicPlayer/2.0.1/player/flash',function (S, Node, SWF) {
    var MusicPlayer,
        swf,
        defaultConfig,
        _obj;
 ...
 * @module musicPlayer
 **/
KISSY.add('gallery/musicPlayer/2.0.1/index',function (S, Node,Base,AUDIO,FLASH) {
    var _this;
    /**
     *
     * @class MusicPlayer
